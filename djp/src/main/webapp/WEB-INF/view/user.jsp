...
<head>
    ...
    <title>用户列表</title>
    <link rel="stylesheet" href="../static/layui/css/layui.css?t=1542630986927" media="all">
    <style>
        body{margin: 10px;}
...
<script src="../static/layui/layui.js?t=1542630986927"></script>
<script>
    layui.config({
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'type', title: '权限类型', width: 150, sort: true,templet:function(d){
                        return  d.type == '0' ? "普通管理员":"<span style='color: red'>超级管理员</span>"}}
                ,{field: 'accountNumber', title: '用户账号', width:150}
                ,{field: 'passWord', title: '用户密码', width: 100}
                ,{field: 'createTime', title: '创建时间', width: 200}
                ,{field: 'createUser', title: '创建人', width: 100, sort: true}
                //,{fixed: 'createUser', width: 165, align:'center', toolbar: '#barDemo'}
